...
import static com.nageoffer.shortlink.admin.common.constant.GenerateConst.GENERATE_TIMES_LIMIT;
...
public class GroupServiceImpl extends ServiceImpl<GroupMapper, GroupDO> implements GroupService {
    ...
    public void saveGroup(String username, String groupName) {
        ...
        try {
            ...
            do {
                if (customGenerateCount++ > GENERATE_TIMES_LIMIT) {
                    throw new ServiceException("分组标识频繁生成，请稍后再试");
                }
